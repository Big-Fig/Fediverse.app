...
class RepostsPage extends StatefulWidget {
  ...
  RepostsPage(this.viewAccount, this.viewStatusDetail, {Key key})
      : super(key: key);

  @override
  _RepostsPage createState() => _RepostsPage();
}

class _RepostsPage extends State<RepostsPage> {
  ...
  void _onRefresh() {
    ...
    CurrentInstance.instance.currentClient
        .run(
            path: NotificationRequest.Notification.getRepostsNotifications(
