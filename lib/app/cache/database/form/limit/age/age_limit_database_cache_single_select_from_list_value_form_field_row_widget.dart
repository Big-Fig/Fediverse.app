    ...
    return AgeLimitDatabaseSelectCacheSingleSelectValueFormFieldBlocProxyProvider(
      child: SingleSelectFromListValueFormFieldRowWidget<
        ...
        valueTitleMapper:
          ...
          if(value == null) {
            return S.of(context).app_cache_database_settings_limitAge_value_notSet;
          }
          ...
          switch (value) {
            ...
            case DatabaseCacheAgeLimitType.days7:
              return S.of(context).app_cache_database_settings_limitAge_value_days7;
              break;
            case DatabaseCacheAgeLimitType.days30:
              return S.of(context).app_cache_database_settings_limitAge_value_days30;
              break;
            case DatabaseCacheAgeLimitType.days90:
              return S.of(context).app_cache_database_settings_limitAge_value_days90;
              break;
            case DatabaseCacheAgeLimitType.days180:
              return S.of(context).app_cache_database_settings_limitAge_value_days180;
              break;
            case DatabaseCacheAgeLimitType.days365:
              return S.of(context).app_cache_database_settings_limitAge_value_days365;
              break;
          }
