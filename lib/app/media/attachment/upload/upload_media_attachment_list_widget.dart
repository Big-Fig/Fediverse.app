...
import 'package:fedi/app/media/attachment/upload/upload_media_attachment_collection_bloc.dart';
import 'package:fedi/app/media/attachment/upload/upload_media_attachment_grid_item_widget.dart';
...
class UploadMediaAttachmentGridWidget extends StatelessWidget {
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Provider<IUploadMediaAttachmentBloc>.value(
                        value: mediaItemBloc,
                        child: const UploadMediaAttachmentGridItem()),
                    Align(
  ...
  const UploadMediaAttachmentGridWidget();
}
