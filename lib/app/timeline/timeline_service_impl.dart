...
abstract class TimelineService extends DisposableOwner
  ...
  Future<bool> refreshItemsFromRemoteForPage(
    ...
    try {
      List<IPleromaStatus> loadedStatuses;
      switch (settings.remoteType) {
        case TimelineRemoteType.public:
          loadedStatuses = await pleromaTimelineService.getPublicTimeline(
        ...
        case TimelineRemoteType.list:
          loadedStatuses = await pleromaTimelineService.getListTimeline(
        ...
        case TimelineRemoteType.home:
          loadedStatuses = await pleromaTimelineService.getHomeTimeline(
            maxId: olderThanStatus?.remoteId,
            sinceId: newerThanStatus?.remoteId,
            limit: limit,
            onlyLocal: settings.onlyLocal,
      ...
      if (loadedStatuses != null) {
        await statusRepository
            .upsertAll(loadedStatuses.map(mapRemoteStatusToDbStatus));
        return true;
      } else {
