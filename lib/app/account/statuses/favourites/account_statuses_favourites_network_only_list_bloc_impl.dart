...
class AccountStatusesFavouritesNetworkOnlyListBloc
  ...
  static AccountStatusesFavouritesNetworkOnlyListBloc createFromContext(
      BuildContext context,
      {@required IAccount account}) {
    return AccountStatusesFavouritesNetworkOnlyListBloc(
      account: account,
  ...
  static Widget provideToContext(BuildContext context,
    ...
    return DisposableProvider<IStatusNetworkOnlyListBloc>(
      create: (context) =>
          AccountStatusesFavouritesNetworkOnlyListBloc.createFromContext(
              context,
              account: account),
