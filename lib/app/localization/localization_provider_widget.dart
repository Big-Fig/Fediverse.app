...
class _LocalizationProviderState extends State<LocalizationProvider> {
  ...
  @override
  void dispose() {
    widget.localizationBloc.dispose();
    super.dispose();
  }
  ...
  @override
  void reassemble() {
    widget.localizationBloc.reassemble();
    super.reassemble();
  }
  ...
  void _init() async {
    ...
    widget.localizationBloc.onChange(Resource(
        locale: locale,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: StreamBuilder<Resource>(
          stream:  widget.localizationBloc.outStream,
...
class _EasyLocalizationProvider extends InheritedWidget {
  final LocalizationProvider parent;
