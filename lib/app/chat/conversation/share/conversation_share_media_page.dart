import 'package:fedi/app/chat/conversation/share/conversation_share_media_bloc_impl.dart';
...
class ConversationShareMediaPage extends StatelessWidget {
  const ConversationShareMediaPage();
  ...
  return MaterialPageRoute(
    builder: (context) => ConversationShareMediaBloc.provideToContext(context,
        ...
        child: Provider<IPleromaMediaAttachment>.value(
          ...
          child: const ConversationShareMediaPage(),
        )),
  );
}
