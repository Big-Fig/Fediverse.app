...
import 'package:fedi/refactored/app/auth/instance/join/register/join_instance_register_model.dart';
import 'package:fedi/refactored/disposable/disposable_owner.dart';
import 'package:rxdart/rxdart.dart';
import 'package:rxdart/subjects.dart';

class JoinInstanceRegisterBloc extends DisposableOwner
    implements IJoinInstanceRegisterBloc {
  final _widgetStatusSubject = BehaviorSubject<JoinInstanceRegisterNetworkState>();
  ...
  // validate email
  Stream<JoinInstanceRegisterNetworkState> get widgetStatus =>
