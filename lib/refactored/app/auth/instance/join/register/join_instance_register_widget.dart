...
class JoinInstanceRegisterWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var joinInstanceRegisterBloc =
        IJoinInstanceRegisterBloc.of(context, listen: false);
  ...
  submit(BuildContext context, IJoinInstanceRegisterBloc bloc) async {
