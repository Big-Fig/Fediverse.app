...
class NotificationUnreadAllBadgeCountWidget extends NotificationUnreadBadgeCountWidget {

  NotificationUnreadAllBadgeCountWidget({@required Widget child}): super
      (child:child);

  @override
  Stream<int> retrieveUnreadBadgeCountStream(BuildContext context) {
    var notificationRepository = INotificationRepository.of(context, listen: false);
