...
var _logger = Logger("notification_pagination_list_bloc_impl.dart");
...
class NotificationPaginationListBloc
  ...
  NotificationPaginationListBloc(
      {@required
          IPaginationBloc<PaginationPage<INotification>, INotification> paginationBloc})
      : super(paginationBloc: paginationBloc);

  static NotificationPaginationListBloc createFromContext(BuildContext context) =>
      NotificationPaginationListBloc(
          paginationBloc:
              Provider.of<IPaginationBloc<PaginationPage<INotification>, INotification>>(
