...
import 'package:fedi/mastodon/timeline/mastodon_timeline_service.dart';
import 'package:fedi/rest/rest_request_model.dart';
import 'package:fedi/rest/rest_response_model.dart';
import 'package:flutter/widgets.dart';
import 'package:path/path.dart';

class MastodonTimelineService implements IMastodonTimelineService {
  final timelineRelativeUrlPath = "/api/v1/timelines/";
  final IMastodonRestService restService;

  MastodonTimelineService({@required this.restService});
  ...
  Future<List<Status>> getHashTagTimeline({
    ...
    List<mastodon.Visibility> excludeVisibilities = const [
      mastodon.Visibility.DIRECT
    ],
  }) {
    assert(hashTag != null);
    return getTimeline(
  ...
  Future<List<Status>> getTimeline(
      ...
      @required List<mastodon.Visibility> excludeVisibilities}) async {
    ...
    if (restResponse.isSuccess) {
      ...
      throw new MastodonTimelineException(
