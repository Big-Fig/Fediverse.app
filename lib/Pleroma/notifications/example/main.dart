...
import 'package:fedi/Pleroma/notifications/websockets/pleroma_notifications_websockets_service_impl.dart';
  ...
  Text mapEventToTextWidget(PleromaNotificationsWebSocketsEvent latestEvent) {
    switch (latestEvent.eventType) {
      case PleromaNotificationsWebSocketsEventType.update:
        return Text(
            "Latest(Status): ${Status.fromJsonString(latestEvent.payload)}");
        break;
      ...
      case PleromaNotificationsWebSocketsEventType.conversation:
        return Text(
            "Latest(conversation): ${Conversation.fromJsonString(latestEvent.payload)}");
        break;
    }
