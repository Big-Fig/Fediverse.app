...
class MastodonAccountAdapter extends TypeAdapter<MastodonAccount> {
  @override
  MastodonAccount read(BinaryReader reader) {
    var obj = MastodonAccount();
  ...
  @override
  void write(BinaryWriter writer, MastodonAccount obj) {
    writer.writeByte(19);
    writer.writeByte(0);
...
class AccountPleromaNotificationsSettingsAdapter
    extends TypeAdapter<AccountPleromaNotificationsSettings> {
  @override
  AccountPleromaNotificationsSettings read(BinaryReader reader) {
    var obj = AccountPleromaNotificationsSettings();
    var numOfFields = reader.readByte();
    for (var i = 0; i < numOfFields; i++) {
      switch (reader.readByte()) {
      }
  ...
  @override
  void write(BinaryWriter writer, AccountPleromaNotificationsSettings obj) {
    writer.writeByte(0);
  }
}

class AccountPleromaAdapter extends TypeAdapter<AccountPleroma> {
  @override
  AccountPleroma read(BinaryReader reader) {
    var obj = AccountPleroma();
    var numOfFields = reader.readByte();
    for (var i = 0; i < numOfFields; i++) {
      switch (reader.readByte()) {
        case 1:
  ...
  @override
  void write(BinaryWriter writer, AccountPleroma obj) {
    writer.writeByte(17);
    writer.writeByte(1);
...
Account _$AccountFromJson(Map<String, dynamic> json) {
  return Account(
    ...
    pleroma: json['pleroma'] == null
        ? null
        : AccountPleroma.fromJson(json['pleroma'] as Map<String, dynamic>),
  )..source = json['source'] == null
      ? null
      : Source.fromJson(json['source'] as Map<String, dynamic>);
}
...
AccountPleromaNotificationsSettings
    _$AccountPleromaNotificationsSettingsFromJson(Map<String, dynamic> json) {
  return AccountPleromaNotificationsSettings(
...
Map<String, dynamic> _$AccountPleromaNotificationsSettingsToJson(
        AccountPleromaNotificationsSettings instance) =>
    <String, dynamic>{
