...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "app_account_my_accountBlock_description" : MessageLookupByLibrary.simpleMessage("Once you’ve blocked an account, they can no longer see things you post on your timeline, tag you, add you to a List, start a chat with you or follow you."),
