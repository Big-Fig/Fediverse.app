...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(instanceDomain) => "Instance: ${instanceDomain}";

  static m2(remoteInstanceDomain) => "Open on ${remoteInstanceDomain}";

  static m3(domain) => "Unblock domain ${domain}";

  static m4(accountAcct) => "${accountAcct} followers";

  static m5(accountAcct) => "${accountAcct} followings";

  static m6(userAtHost) => "Settings: ${userAtHost}";

  static m7(number) => "Link field #${number}";

  static m8(host) => "Forward to ${host}";

  static m9(userAtHost) => "Report ${userAtHost}";

  static m10(message) => "Message: ${message}";
  ...
  static m14(error) => "Details: ${error}";

  static m15(userAtHost) => "Log out of ${userAtHost}";

  static m16(errorDescription) => "Error during login: ${errorDescription}";
  ...
  static m20(userAtHost) => "Clear whole cache (${userAtHost})";

  static m21(userAtHost) => "Clear cache by limits (${userAtHost})";
  ...
  static m26(localDomain) => "Open on ${localDomain} inside app";

  static m27(remoteDomain) => "Open on ${remoteDomain} in browser";

  static m28(hashtag) => "#${hashtag}";

  static m29(sizeInMb) => "${sizeInMb} MB";

  static m30(instanceDomain) => "Instance: ${instanceDomain}";

  static m31(mediaType) => "Not supported type ${mediaType}";

  static m32(formattedFileSize, formattedMaxFileSize) =>
      "File size is ${formattedFileSize} MB, but max is ${formattedMaxFileSize} MB";

  static m33(status) => "<b>Mentioned you:</b> ${status}.";

  static m34(status) => "<b>Chat:</b> ${status}.";

  static m35(emoji) => "${emoji} for your post.";

  static m36(acct) => "Report from ${acct}";

  static m37(status) => "Unknown: ${status}";

  static m38(count) =>
      "${Intl.plural(count, one: '1 new notification. Tap to load.', other: '${count} new notifications. Tap to load.')}";

  static m39(dayCount) => " ${dayCount} left";
  ...
  static m42(remoteInstanceDomain) => "Open on ${remoteInstanceDomain}";

  static m43(errorMessage) => "Error: ${errorMessage}";

  static m44(count) =>
      "${Intl.plural(count, one: '1 new post. Tap to load.', other: '${count} new posts. Tap to load.')}";

  static m45(errorMessage) => "Error: ${errorMessage}";

  static m46(optionNumber) => "Option ${optionNumber}";

  static m47(accountAcct) => "Replying to ${accountAcct}";

  static m48(accountAcct) => "Reply to @${accountAcct}";

  static m49(timeline) => "${timeline} Timeline";

  static m50(timeline) =>
      "Are you sure you want to delete ${timeline} Timeline?";

  static m51(errorMessage) => "Failed to init ${errorMessage}";

  static m52(errorMessage) => "An error has occurred. \n${errorMessage}";
  ...
  static m59(min, max) => "Should be between ${min} and ${max}";

  static m60(min) => "Should be at least ${min}";

  static m61(maxCharactersCount) =>
  ...
  static m63(minCharactersCount) =>
      "Must be at least ${minCharactersCount} characters";

  static m64(url) => "URL ${url} have invalid format";

  static m65(days) => "${Intl.plural(days, one: '1 d', other: '${days} d')}";

  static m66(hours) => "${Intl.plural(hours, one: '1 h', other: '${hours} h')}";
  ...
  static m69(years) => "${Intl.plural(years, one: '1 y', other: '${years} y')}";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "app_account_domainBlock_description":
            MessageLookupByLibrary.simpleMessage(
        ...
        "app_account_mute_dialog_title":
            MessageLookupByLibrary.simpleMessage("Muting"),
