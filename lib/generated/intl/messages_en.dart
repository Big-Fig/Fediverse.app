...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m36(status) => "Unknown: ${status}";

  static m37(count) => "${Intl.plural(count, one: '1 new notification. Tap to load.', other: '${count} new notifications. Tap to load.')}";

  static m38(dayCount) => " ${dayCount} left";

  static m39(count) => "${Intl.plural(count, zero: 'No votes', one: '1 vote', other: '${count} votes')}";

  static m40(userAtHost) => "Настройки: ${userAtHost}";

  static m41(remoteInstanceDomain) => "Open on ${remoteInstanceDomain}";

  static m42(errorMessage) => "Error: ${errorMessage}";

  static m43(count) => "${Intl.plural(count, one: '1 new post. Tap to load.', other: '${count} new posts. Tap to load.')}";

  static m44(errorMessage) => "Error: ${errorMessage}";

  static m45(optionNumber) => "Option ${optionNumber}";

  static m46(accountAcct) => "Replying to ${accountAcct}";

  static m47(accountAcct) => "Reply to @${accountAcct}";

  static m48(timeline) => "${timeline} Timeline";

  static m49(timeline) => "Are you sure you want to delete ${timeline} Timeline?";

  static m50(errorMessage) => "Failed to init ${errorMessage}";

  static m51(errorMessage) => "An error has occurred. \n${errorMessage}";

  static m52(count) => "${Intl.plural(count, one: '1 day', other: '${count} days')}";

  static m53(count) => "${Intl.plural(count, one: '1 hour', other: '${count} hours')}";

  static m54(count) => "${Intl.plural(count, one: '1 minute', other: '${count} minutes')}";

  static m55(selectionCountLimit) => "Maximum ${selectionCountLimit}";

  static m56(selectionCount) => "Selected (${selectionCount})";

  static m57(max) => "Should be not more than ${max}";

  static m58(min, max) => "Should be between ${min} and ${max}";

  static m59(min) => "Should be at least ${min}";

  static m60(maxCharactersCount) => "Must be less than ${maxCharactersCount} characters";

  static m61(minCharactersCount, maxCharactersCount) => "Must be between ${minCharactersCount} and ${maxCharactersCount} characters";

  static m62(minCharactersCount) => "Must be at least ${minCharactersCount} characters";

  static m63(url) => "URL ${url} have invalid format";

  static m64(days) => "${Intl.plural(days, one: '1 d', other: '${days} d')}";

  static m65(hours) => "${Intl.plural(hours, one: '1 h', other: '${hours} h')}";

  static m66(minutes) => "${Intl.plural(minutes, one: '1 min', other: '${minutes} min')}";

  static m67(months) => "${Intl.plural(months, one: '1 mo', other: '${months} mo')}";

  static m68(years) => "${Intl.plural(years, one: '1 y', other: '${years} y')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "app_chat_message_pending_actions_dialog_action_delete" : MessageLookupByLibrary.simpleMessage("Delete"),
