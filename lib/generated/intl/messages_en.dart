...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m12(userAtHost) => "Can\'t load ${userAtHost} instance.\nApp error or session expired";
  ...
  static m22(count) => "${Intl.plural(count, one: '1 new conversation. Tap to load.', other: '${count} new conversations. Tap to load.')}";

  static m23(count) => "${Intl.plural(count, one: '1 new chat. Tap to load.', other: '${count} new chats. Tap to load.')}";
  ...
  static m32(formattedFileSize, formattedMaxFileSize) => "File size is ${formattedFileSize} MB, but max is ${formattedMaxFileSize} MB";
  ...
  static m38(count) => "${Intl.plural(count, one: '1 new notification. Tap to load.', other: '${count} new notifications. Tap to load.')}";

  static m39(dayCount) => " ${dayCount} left";

  static m40(count) => "${Intl.plural(count, zero: 'No votes', one: '1 vote', other: '${count} votes')}";
  ...
  static m44(count) => "${Intl.plural(count, one: '1 new post. Tap to load.', other: '${count} new posts. Tap to load.')}";
  ...
  static m50(timeline) => "Are you sure you want to delete ${timeline} Timeline?";

  static m51(errorMessage) => "Failed to init ${errorMessage}";

  static m52(errorMessage) => "An error has occurred. \n${errorMessage}";

  static m53(count) => "${Intl.plural(count, one: '1 day', other: '${count} days')}";

  static m54(count) => "${Intl.plural(count, one: '1 hour', other: '${count} hours')}";

  static m55(count) => "${Intl.plural(count, one: '1 minute', other: '${count} minutes')}";
  ...
  static m61(maxCharactersCount) => "Must be less than ${maxCharactersCount} characters";

  static m62(minCharactersCount, maxCharactersCount) => "Must be between ${minCharactersCount} and ${maxCharactersCount} characters";

  static m63(minCharactersCount) => "Must be at least ${minCharactersCount} characters";
  ...
  static m67(minutes) => "${Intl.plural(minutes, one: '1 min', other: '${minutes} min')}";

  static m68(months) => "${Intl.plural(months, one: '1 mo', other: '${months} mo')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "app_account_action_subscribe" : MessageLookupByLibrary.simpleMessage("Subscribe"),
    ...
    "app_account_action_unsubscribe" : MessageLookupByLibrary.simpleMessage("Unsubscribe"),
    ...
    "app_account_mute_dialog_action_clearDate" : MessageLookupByLibrary.simpleMessage("Clear date"),
    "app_account_mute_dialog_action_mute" : MessageLookupByLibrary.simpleMessage("Mute"),
    "app_account_mute_dialog_field_expire_label" : MessageLookupByLibrary.simpleMessage("Expire"),
    "app_account_mute_dialog_field_notifications_description" : MessageLookupByLibrary.simpleMessage("Additionally mute notifications"),
    "app_account_mute_dialog_field_notifications_label" : MessageLookupByLibrary.simpleMessage("Notifications"),
    "app_account_mute_dialog_title" : MessageLookupByLibrary.simpleMessage("Snooze User"),
    ...
    "app_account_my_action_filters" : MessageLookupByLibrary.simpleMessage("Filters"),
    ...
    "app_account_my_customList_list_title" : MessageLookupByLibrary.simpleMessage("Lists"),
    ...
    "app_account_my_edit_field_bot_description" : MessageLookupByLibrary.simpleMessage("Mark if current account is bot"),
    "app_account_my_edit_field_bot_label" : MessageLookupByLibrary.simpleMessage("Bot"),
    ...
    "app_account_my_edit_field_discoverable_description" : MessageLookupByLibrary.simpleMessage("Search engines & Profile directory"),
    "app_account_my_edit_field_discoverable_label" : MessageLookupByLibrary.simpleMessage("Discoverable"),
    "app_account_my_edit_field_displayName_hint" : MessageLookupByLibrary.simpleMessage("John Smith"),
    ...
    "app_account_my_edit_field_locked_description" : MessageLookupByLibrary.simpleMessage("You should manually approve follow requests"),
    "app_account_my_edit_field_locked_label" : MessageLookupByLibrary.simpleMessage("Locked to followers only"),
    "app_account_my_edit_field_note_hint" : MessageLookupByLibrary.simpleMessage("Your bio and links to your pages"),
    "app_account_my_edit_field_note_label" : MessageLookupByLibrary.simpleMessage("Note"),
    "app_account_my_edit_field_pleroma_acceptsChatMessages_description" : MessageLookupByLibrary.simpleMessage("Disable to reject all messages"),
    "app_account_my_edit_field_pleroma_acceptsChatMessages_label" : MessageLookupByLibrary.simpleMessage("Accepts chat messages"),
    "app_account_my_edit_field_pleroma_allowFollowingMove_description" : MessageLookupByLibrary.simpleMessage("Automatically follow moved accounts"),
    "app_account_my_edit_field_pleroma_allowFollowingMove_label" : MessageLookupByLibrary.simpleMessage("Allow following move"),
    "app_account_my_edit_field_pleroma_background_dialog_action_crop" : MessageLookupByLibrary.simpleMessage("Crop"),
    "app_account_my_edit_field_pleroma_background_dialog_action_select" : MessageLookupByLibrary.simpleMessage("Select"),
    "app_account_my_edit_field_pleroma_background_dialog_title" : MessageLookupByLibrary.simpleMessage("Pleroma background"),
    "app_account_my_edit_field_pleroma_hideFavourites_description" : MessageLookupByLibrary.simpleMessage("Only private access to favourites list"),
    "app_account_my_edit_field_pleroma_hideFavourites_label" : MessageLookupByLibrary.simpleMessage("Hide favourites"),
    "app_account_my_edit_field_pleroma_hideFollowersCount_description" : MessageLookupByLibrary.simpleMessage("Display \'0\' as followers count"),
    "app_account_my_edit_field_pleroma_hideFollowersCount_label" : MessageLookupByLibrary.simpleMessage("Hide followers count"),
    "app_account_my_edit_field_pleroma_hideFollowers_description" : MessageLookupByLibrary.simpleMessage("Only private access to followers list"),
    "app_account_my_edit_field_pleroma_hideFollowers_label" : MessageLookupByLibrary.simpleMessage("Hide followers"),
    "app_account_my_edit_field_pleroma_hideFollowsCount_description" : MessageLookupByLibrary.simpleMessage("Display \'0\' as follows count"),
    "app_account_my_edit_field_pleroma_hideFollowsCount_label" : MessageLookupByLibrary.simpleMessage("Hide follows count"),
    "app_account_my_edit_field_pleroma_hideFollows_description" : MessageLookupByLibrary.simpleMessage("Only private access to follows list"),
    "app_account_my_edit_field_pleroma_hideFollows_label" : MessageLookupByLibrary.simpleMessage("Hide follows"),
    "app_account_my_edit_field_pleroma_noRichText_description" : MessageLookupByLibrary.simpleMessage("Strip html tags"),
    "app_account_my_edit_field_pleroma_noRichText_label" : MessageLookupByLibrary.simpleMessage("Ignore rich text"),
    "app_account_my_edit_field_pleroma_showRole_description" : MessageLookupByLibrary.simpleMessage("e.g. Admin, Moderator"),
    "app_account_my_edit_field_pleroma_showRole_label" : MessageLookupByLibrary.simpleMessage("Show role"),
    "app_account_my_edit_field_pleroma_skipThreadContainment_description" : MessageLookupByLibrary.simpleMessage("Ignore broken threads"),
    "app_account_my_edit_field_pleroma_skipThreadContainment_label" : MessageLookupByLibrary.simpleMessage("Skip thread containment"),
    ...
    "app_auth_instance_register_cantLogin_notification_title" : MessageLookupByLibrary.simpleMessage("Success registration"),
    "app_auth_instance_register_emailConfirmationRequired_notification_content" : MessageLookupByLibrary.simpleMessage("Please confirm email before login"),
    "app_auth_instance_register_emailConfirmationRequired_notification_title" : MessageLookupByLibrary.simpleMessage("Success registration"),
    "app_auth_instance_register_field_acceptTermsOfService_description" : m17,
    "app_auth_instance_register_field_acceptTermsOfService_label" : MessageLookupByLibrary.simpleMessage("Accept Terms of Service"),
    ...
    "app_auth_instance_register_field_locale_description" : MessageLookupByLibrary.simpleMessage("Default language for your statuses and confirmation email"),
    ...
    "app_cache_database_settings_currentEntriesCountByType_label" : MessageLookupByLibrary.simpleMessage("Current max entries count by type"),
    "app_cache_database_settings_currentEntriesCountByType_value" : m18,
    "app_cache_database_settings_currentMaxAge_label" : MessageLookupByLibrary.simpleMessage("Current max age"),
    "app_cache_database_settings_currentMaxAge_value" : m19,
    "app_cache_database_settings_description" : MessageLookupByLibrary.simpleMessage("Accounts, statuses, conversation, notifications and chats. Huge limits may cause bad performance due to complex calculations for big amount of data.\n Exceed limits data will be deleted on each app start."),
    "app_cache_database_settings_limitAge_label" : MessageLookupByLibrary.simpleMessage("Age limit"),
    "app_cache_database_settings_limitAge_value_days180" : MessageLookupByLibrary.simpleMessage("180 days"),
    "app_cache_database_settings_limitAge_value_days30" : MessageLookupByLibrary.simpleMessage("30 days"),
    "app_cache_database_settings_limitAge_value_days365" : MessageLookupByLibrary.simpleMessage("1 year"),
    "app_cache_database_settings_limitAge_value_days7" : MessageLookupByLibrary.simpleMessage("7 days"),
    "app_cache_database_settings_limitAge_value_days90" : MessageLookupByLibrary.simpleMessage("90 days"),
    "app_cache_database_settings_limitAge_value_notSet" : MessageLookupByLibrary.simpleMessage("No"),
    "app_cache_database_settings_limitEntriesCountByType_label" : MessageLookupByLibrary.simpleMessage("Entries count per type limit"),
    "app_cache_database_settings_limitEntriesCountByType_value_limit1000" : MessageLookupByLibrary.simpleMessage("1000 entries"),
    "app_cache_database_settings_limitEntriesCountByType_value_limit10000" : MessageLookupByLibrary.simpleMessage("10000 entries"),
    "app_cache_database_settings_limitEntriesCountByType_value_limit100000" : MessageLookupByLibrary.simpleMessage("100000 entries"),
    "app_cache_database_settings_limitEntriesCountByType_value_limit5000" : MessageLookupByLibrary.simpleMessage("5000 entries"),
    "app_cache_database_settings_limitEntriesCountByType_value_notSet" : MessageLookupByLibrary.simpleMessage("No"),
    "app_cache_database_settings_title" : MessageLookupByLibrary.simpleMessage("Databаse cache"),
    "app_cache_files_settings_description" : MessageLookupByLibrary.simpleMessage("Exceed limits data will be deleted on each app start."),
    "app_cache_files_settings_limitAge_label" : MessageLookupByLibrary.simpleMessage("Age limit"),
    "app_cache_files_settings_limitAge_value_days180" : MessageLookupByLibrary.simpleMessage("180 days"),
    "app_cache_files_settings_limitAge_value_days30" : MessageLookupByLibrary.simpleMessage("30 days"),
    "app_cache_files_settings_limitAge_value_days365" : MessageLookupByLibrary.simpleMessage("1 year"),
    "app_cache_files_settings_limitAge_value_days7" : MessageLookupByLibrary.simpleMessage("7 days"),
    "app_cache_files_settings_limitAge_value_days90" : MessageLookupByLibrary.simpleMessage("90 days"),
    "app_cache_files_settings_limitAge_value_notSet" : MessageLookupByLibrary.simpleMessage("No"),
    "app_cache_files_settings_sizeLimit_label" : MessageLookupByLibrary.simpleMessage("Objects count limit"),
    "app_cache_files_settings_sizeLimit_value_notSet" : MessageLookupByLibrary.simpleMessage("No"),
    ...
    "app_chat_message_deleted_desc" : MessageLookupByLibrary.simpleMessage("Message deleted"),
    "app_chat_message_pending_actions_dialog_action_delete" : MessageLookupByLibrary.simpleMessage("Delete message"),
    "app_chat_message_pending_actions_dialog_action_resend" : MessageLookupByLibrary.simpleMessage("Send again"),
    "app_chat_message_pending_actions_dialog_title" : MessageLookupByLibrary.simpleMessage("Pending message"),
    "app_chat_message_pending_desc" : MessageLookupByLibrary.simpleMessage("Message pending."),
    "app_chat_message_pending_failed_desc" : MessageLookupByLibrary.simpleMessage("Message failed to send."),
    "app_chat_message_pending_tapToViewOptions" : MessageLookupByLibrary.simpleMessage("Tap to view options."),
    "app_chat_pleroma_account_notAcceptsChatMessages_toast" : MessageLookupByLibrary.simpleMessage("User disabled chat feature"),
    ...
    "app_datetime_picker_action_delete" : MessageLookupByLibrary.simpleMessage("Delete"),
    "app_datetime_picker_action_done" : MessageLookupByLibrary.simpleMessage("Done"),
    ...
    "app_duration_picker_action_cancel" : MessageLookupByLibrary.simpleMessage("Cancel"),
    "app_duration_picker_action_delete" : MessageLookupByLibrary.simpleMessage("Delete"),
    "app_duration_picker_action_done" : MessageLookupByLibrary.simpleMessage("Done"),
    "app_duration_value_null" : MessageLookupByLibrary.simpleMessage("Never"),
    ...
    "app_filter_context_type_unknown" : MessageLookupByLibrary.simpleMessage("Unknown"),
    ...
    "app_filter_edit_field_expiresIn_description" : MessageLookupByLibrary.simpleMessage("Expired filters are not automatically deleted, but can be reactivated"),
    "app_filter_edit_field_expiresIn_label" : MessageLookupByLibrary.simpleMessage("Expires in"),
    "app_filter_edit_field_irreversible_description" : MessageLookupByLibrary.simpleMessage("Filter statuses on server-side (irreversible)"),
    "app_filter_edit_field_irreversible_label" : MessageLookupByLibrary.simpleMessage("Drop instead of hide"),
    "app_filter_edit_field_phrase_hint" : MessageLookupByLibrary.simpleMessage("Not sensitive to case"),
    "app_filter_edit_field_phrase_label" : MessageLookupByLibrary.simpleMessage("Phrase"),
    "app_filter_edit_field_wholeWord_description" : MessageLookupByLibrary.simpleMessage("Apply only if phrase exactly matched"),
    "app_filter_edit_field_wholeWord_error_invalid_phrase" : MessageLookupByLibrary.simpleMessage("Phrase should be alphanumeric only"),
    "app_filter_edit_field_wholeWord_label" : MessageLookupByLibrary.simpleMessage("Whole word"),
    "app_filter_edit_title" : MessageLookupByLibrary.simpleMessage("Edit filter"),
    "app_filter_expired" : MessageLookupByLibrary.simpleMessage("Expired"),
    "app_filter_list_action_add" : MessageLookupByLibrary.simpleMessage("Add Filter"),
    "app_filter_list_empty" : MessageLookupByLibrary.simpleMessage("You haven’t created any Filters yet."),
    "app_filter_list_title" : MessageLookupByLibrary.simpleMessage("Filters"),
    ...
    "app_instance_details_field_approvalRequired_label" : MessageLookupByLibrary.simpleMessage("Approval required"),
    "app_instance_details_field_chatLimit_label" : MessageLookupByLibrary.simpleMessage("Max chat message length"),
    "app_instance_details_field_contactAccount_label" : MessageLookupByLibrary.simpleMessage("Contact"),
    "app_instance_details_field_details_title" : MessageLookupByLibrary.simpleMessage("Details"),
    "app_instance_details_field_email_label" : MessageLookupByLibrary.simpleMessage("Email"),
    "app_instance_details_field_federation_enabled_label" : MessageLookupByLibrary.simpleMessage("Enabled"),
    "app_instance_details_field_federation_exclusions_label" : MessageLookupByLibrary.simpleMessage("Exclusions"),
    ...
    "app_instance_details_field_federation_quarantinedInstances_label" : MessageLookupByLibrary.simpleMessage("Quarantined Instances"),
    "app_instance_details_field_federation_title" : MessageLookupByLibrary.simpleMessage("Federation"),
    "app_instance_details_field_imageDescriptionLimit_label" : MessageLookupByLibrary.simpleMessage("Max media description length"),
    "app_instance_details_field_invitesEnabled_label" : MessageLookupByLibrary.simpleMessage("Invites Enabled"),
    "app_instance_details_field_languages_label" : MessageLookupByLibrary.simpleMessage("Languages"),
    "app_instance_details_field_maxTootChars_label" : MessageLookupByLibrary.simpleMessage("Max status length"),
    "app_instance_details_field_messagesLimits_title" : MessageLookupByLibrary.simpleMessage("Messages limits"),
    "app_instance_details_field_metadata_title" : MessageLookupByLibrary.simpleMessage("Metadata"),
    "app_instance_details_field_pleroma_metadata_features_label" : MessageLookupByLibrary.simpleMessage("Features"),
    "app_instance_details_field_pleroma_metadata_fields_maxFields_label" : MessageLookupByLibrary.simpleMessage("Max fields count"),
    "app_instance_details_field_pleroma_metadata_fields_maxRemoteFields_label" : MessageLookupByLibrary.simpleMessage("Max remote fields count"),
    "app_instance_details_field_pleroma_metadata_fields_nameLength_label" : MessageLookupByLibrary.simpleMessage("Max name length"),
    "app_instance_details_field_pleroma_metadata_fields_postFormats_label" : MessageLookupByLibrary.simpleMessage("Post formats"),
    "app_instance_details_field_pleroma_metadata_fields_title" : MessageLookupByLibrary.simpleMessage("Fields limit"),
    "app_instance_details_field_pleroma_metadata_fields_valueLength_label" : MessageLookupByLibrary.simpleMessage("Max value length"),
    ...
    "app_instance_details_field_pleroma_metadata_fields_verstionType_value_unknown" : MessageLookupByLibrary.simpleMessage("Unknown"),
    "app_instance_details_field_pollLimit_maxExpiration_label" : MessageLookupByLibrary.simpleMessage("Max expiration"),
    "app_instance_details_field_pollLimit_maxOptionsChars_label" : MessageLookupByLibrary.simpleMessage("Max options length"),
    "app_instance_details_field_pollLimit_maxOptions_label" : MessageLookupByLibrary.simpleMessage("Max options count"),
    "app_instance_details_field_pollLimit_minExpiration_label" : MessageLookupByLibrary.simpleMessage("Min expiration"),
    "app_instance_details_field_pollLimit_title" : MessageLookupByLibrary.simpleMessage("Poll limits"),
    "app_instance_details_field_registrationsLimits_title" : MessageLookupByLibrary.simpleMessage("Registration limits"),
    "app_instance_details_field_registrations_label" : MessageLookupByLibrary.simpleMessage("Registrations enabled"),
    "app_instance_details_field_stats_domainCount_label" : MessageLookupByLibrary.simpleMessage("Federation domains"),
    "app_instance_details_field_stats_statusCount_label" : MessageLookupByLibrary.simpleMessage("Statuses"),
    "app_instance_details_field_stats_title" : MessageLookupByLibrary.simpleMessage("Statistic"),
    "app_instance_details_field_stats_userCount_label" : MessageLookupByLibrary.simpleMessage("Users"),
    "app_instance_details_field_uploadAvatar_label" : MessageLookupByLibrary.simpleMessage("Upload avatar limit"),
    "app_instance_details_field_uploadBackground_label" : MessageLookupByLibrary.simpleMessage("Upload background limit"),
    "app_instance_details_field_uploadBanner_label" : MessageLookupByLibrary.simpleMessage("Upload banner limit"),
    "app_instance_details_field_uploadLimits_title" : MessageLookupByLibrary.simpleMessage("Upload limits"),
    "app_instance_details_field_uploadMedia_label" : MessageLookupByLibrary.simpleMessage("Upload media limit"),
    ...
    "app_notification_all_dialog_action_dismissAll" : MessageLookupByLibrary.simpleMessage("Dismiss ALL"),
    "app_notification_all_dialog_action_markAllAsRead" : MessageLookupByLibrary.simpleMessage("Mark ALL as read"),
    "app_notification_all_dialog_action_pushNotifications" : MessageLookupByLibrary.simpleMessage("Push notifications settings"),
    "app_notification_all_dialog_title" : MessageLookupByLibrary.simpleMessage("Notifications"),
    ...
    "app_status_copyLink_toast" : MessageLookupByLibrary.simpleMessage("Copied in clipboard"),
    "app_status_delete_dialog_action_delete" : MessageLookupByLibrary.simpleMessage("Delete"),
    "app_status_delete_dialog_action_deleteAndSaveToDrafts" : MessageLookupByLibrary.simpleMessage("Delete and save to drafts"),
    "app_status_delete_dialog_action_deleteAndStartNew" : MessageLookupByLibrary.simpleMessage("Delete and start new status"),
    "app_status_delete_dialog_title" : MessageLookupByLibrary.simpleMessage("Delete actions"),
    ...
    "app_status_expire_datetime_picker_title" : MessageLookupByLibrary.simpleMessage("Expire at"),
    ...
    "app_status_mute_dialog_action_mute" : MessageLookupByLibrary.simpleMessage("Mute"),
    "app_status_mute_dialog_field_expire_label" : MessageLookupByLibrary.simpleMessage("Expire"),
    "app_status_mute_dialog_title" : MessageLookupByLibrary.simpleMessage("Muting conversation"),
    ...
    "app_status_post_schedule_error_notInFuture_dialog_title" : MessageLookupByLibrary.simpleMessage("Invalid date or time"),
    ...
    "app_status_scheduled_datetime_picker_title" : MessageLookupByLibrary.simpleMessage("Schedule at"),
    ...
    "app_timeline_settings_field_excludeVisibilites_label" : MessageLookupByLibrary.simpleMessage("Exclude visibilities"),
    ...
    "app_timeline_settings_onlyFromInstance_field_label" : MessageLookupByLibrary.simpleMessage("Only from instance"),
    ...
    "app_timeline_settings_replyVisibilityFilter_following" : MessageLookupByLibrary.simpleMessage("Following & Self"),
    ...
    "app_toast_handling_type_never" : MessageLookupByLibrary.simpleMessage("Never"),
    "app_toast_handling_type_onlyWhenInstanceNotSelected" : MessageLookupByLibrary.simpleMessage("When app with account in foreground"),
    "app_toast_handling_type_onlyWhenInstanceSelected" : MessageLookupByLibrary.simpleMessage("When app or account in background"),
    ...
    "app_ui_fontSize_type_large" : MessageLookupByLibrary.simpleMessage("Large"),
    "app_ui_fontSize_type_largest" : MessageLookupByLibrary.simpleMessage("Largest"),
    "app_ui_fontSize_type_medium" : MessageLookupByLibrary.simpleMessage("Medium"),
    "app_ui_fontSize_type_small" : MessageLookupByLibrary.simpleMessage("Small"),
    "app_ui_fontSize_type_smallest" : MessageLookupByLibrary.simpleMessage("Smallest"),
    "app_ui_settings_title" : MessageLookupByLibrary.simpleMessage("UI"),
    "app_ui_statusFontSize" : MessageLookupByLibrary.simpleMessage("Status font size"),
