...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(number) => "Ссылка #${number}";

  static m5(message) => "Сообщение: ${message}";

  static m6(content) => "${content}";

  static m7(userAtHost) => "Не получается загрузить ${userAtHost}.\nОшибка приложения или сессия истекла";

  static m8(userAtHost) => "${userAtHost}";

  static m9(error) => "Детали: ${error}";

  static m10(userAtHost) => "Выйти из ${userAtHost}";

  static m11(count) => "${Intl.plural(count, one: '1 новая беседа. Нажмите для загрузки.', other: '${count} новых бесед. Нажмите для загрузки.')}";

  static m12(count) => "${Intl.plural(count, one: '1 новый чат. Нажмите для загрузки.', other: '${count} новых чатов. Нажмите для загрузки.')}";

  static m13(message) => "Вы: ${message}";

  static m14(listTitle) => "Список ${listTitle}";
  ...
  static m17(status) => "Понравилось: ${status}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "app_account_my_menu_action_account" : MessageLookupByLibrary.simpleMessage("Аккаунт"),
    "app_account_my_menu_action_bookmarks" : MessageLookupByLibrary.simpleMessage("Закладки"),
    "app_account_my_menu_action_lists" : MessageLookupByLibrary.simpleMessage("Списки"),
    "app_account_my_menu_action_settings" : MessageLookupByLibrary.simpleMessage("Настройки"),
    "app_account_my_settings_action_accountBlocks" : MessageLookupByLibrary.simpleMessage("Заблокированные аккаунты"),
    "app_account_my_settings_action_accountMutes" : MessageLookupByLibrary.simpleMessage("Скрытые аккаунты"),
    "app_account_my_settings_action_bookmarked" : MessageLookupByLibrary.simpleMessage("Закладки"),
    "app_account_my_settings_action_domainBlocks" : MessageLookupByLibrary.simpleMessage("Заблокированные серверы"),
    "app_account_my_settings_action_draftPosts" : MessageLookupByLibrary.simpleMessage("Черновики"),
    "app_account_my_settings_action_favourited" : MessageLookupByLibrary.simpleMessage("Избранное"),
    "app_account_my_settings_action_followRequests" : MessageLookupByLibrary.simpleMessage("Запросы подписчиков"),
    "app_account_my_settings_action_lists" : MessageLookupByLibrary.simpleMessage("Списки"),
    "app_account_my_settings_action_scheduledPosts" : MessageLookupByLibrary.simpleMessage("Запланированны записи"),
    "app_account_my_settings_field_alwaysShowNsfw_label" : MessageLookupByLibrary.simpleMessage("Показывать NSFW по умолчанию"),
    "app_account_my_settings_field_alwaysShowSpoiler_label" : MessageLookupByLibrary.simpleMessage("Показывать спойлеры по умолчанию"),
    ...
    "app_account_my_settings_field_websocketsEnabled_label" : MessageLookupByLibrary.simpleMessage("Обновления в реальном времени (WebSockets)"),
    ...
    "app_home_tab_timelines_tab_home" : MessageLookupByLibrary.simpleMessage("Подписки"),
    "app_home_tab_timelines_tab_local" : MessageLookupByLibrary.simpleMessage("Локальные"),
    "app_home_tab_timelines_tab_public" : MessageLookupByLibrary.simpleMessage("Все"),
    ...
    "app_notification_push_settings_title" : MessageLookupByLibrary.simpleMessage("Настройки push оповещений"),
    ...
    "app_timeline_type_public" : MessageLookupByLibrary.simpleMessage("Локальные"),
