...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m26(instanceDomain) => "Сервер: ${instanceDomain}";

  static m27(mediaType) => "Не поддерживается ${mediaType}";

  static m28(formattedFileSize, formattedMaxFileSize) => "Размер файла ${formattedFileSize} MB, но максимум ${formattedMaxFileSize} MB";

  static m29(status) => "<b>Упоминул вас:</b> ${status}.";

  static m30(status) => "<b>Чат:</b> ${status}.";

  static m31(emoji) => "Оценил вашу запись: ${emoji}.";

  static m32(status) => "Неизвестно: ${status}";

  static m33(count) => "${Intl.plural(count, one: '1 новое оповещение. Нажмите для загрузки.', other: '${count} новых оповещений. Нажмите для загрузки.')}";

  static m34(dayCount) => " ${dayCount} осталось";

  static m35(count) => "${Intl.plural(count, zero: 'Нет голосов', one: '1 голос', other: '${count} голосов')}";
  ...
  static m40(errorMessage) => "Ошибка: ${errorMessage}";

  static m41(optionNumber) => "Ответ ${optionNumber}";

  static m42(accountAcct) => "Ответ: ${accountAcct}";

  static m43(accountAcct) => "Ответ: @${accountAcct}";

  static m44(timeline) => "Лента ${timeline}";

  static m45(timeline) => "Вы действительно хотите удалить ленту: ${timeline}?";

  static m46(errorMessage) => "Ошибка инициализации: ${errorMessage}";

  static m47(errorMessage) => "Ошибка: \n${errorMessage}";

  static m48(count) => "${Intl.plural(count, one: '1 день', other: '${count} дни')}";

  static m49(count) => "${Intl.plural(count, one: '1 час', other: '${count} часы')}";

  static m50(count) => "${Intl.plural(count, one: '1 минута', other: '${count} минуты')}";

  static m51(selectionCountLimit) => "Максимум ${selectionCountLimit}";

  static m52(max) => "Не больше ${max}";

  static m53(min, max) => "Должны быть между ${min} и ${max}";

  static m54(min) => "Не меньше ${min}";

  static m55(maxCharactersCount) => "Максимальная длина: ${maxCharactersCount}";

  static m56(minCharactersCount, maxCharactersCount) => "Длина должна быть между ${minCharactersCount} и ${maxCharactersCount}";

  static m57(minCharactersCount) => "Минимальная длина: ${minCharactersCount}";

  static m58(url) => "URL ${url} имеет неправильный формат";

  static m59(days) => "${Intl.plural(days, one: '1 д', other: '${days} д')}";

  static m60(hours) => "${Intl.plural(hours, one: '1 ч', other: '${hours} ч')}";

  static m61(minutes) => "${Intl.plural(minutes, one: '1 мин', other: '${minutes} мин')}";

  static m62(months) => "${Intl.plural(months, one: '1 мес', other: '${months} мес')}";

  static m63(years) => "${Intl.plural(years, one: '1 г', other: '${years} г')}";
