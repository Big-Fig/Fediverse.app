...
void expectDbFilter(IFilter actual, DbFilter dbFilter) {
  expect(actual.remoteId, dbFilter.remoteId);

  expect(actual.phrase, dbFilter.phrase);
  expect(eq(actual.context, dbFilter.context), true);
  expect(actual.irreversible, dbFilter.irreversible);
  expect(actual.wholeWord, dbFilter.wholeWord);
  expect(actual.expiresAt, dbFilter.expiresAt);
}
