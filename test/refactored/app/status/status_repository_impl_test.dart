...
void main() {
  ...
  test('createQuery onlyNotMuted', () async {
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed1", dbAccount, pleromaThreadMuted: null))
            .copyWith(muted: true));
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed2", dbAccount, pleromaThreadMuted: false))
            .copyWith(muted: true));
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed3", dbAccount, pleromaThreadMuted: true))
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed4", dbAccount, pleromaThreadMuted: true))
            .copyWith(muted: true));
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed5", dbAccount, pleromaThreadMuted: false))
            .copyWith(muted: false));
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus("seed6", dbAccount, pleromaThreadMuted: null))
            .copyWith(muted: false));
  ...
  test('createQuery onlyFromAccountsFollowingByAccount', () async {
    ...
    await accountRepository.updateAccountFollowings(accountRemoteId, [
      mapLocalAccountToRemoteAccount(DbAccountWrapper(
          createTestAccount(followingAccountRemoteId)
  ...
  test('createQuery withHashtag', () async {
    ...
    var dbStatus1 =
        (await createTestStatus("seed1", dbAccount)).copyWith(tags: null);
    ...
    var dbStatus2 =
        (await createTestStatus("seed2", dbAccount)).copyWith(tags: []);
    ...
    var dbStatus4 =
        (await createTestStatus("seed4", dbAccount)).copyWith(tags: [
    ...
    var dbStatus5 =
        (await createTestStatus("seed5", dbAccount)).copyWith(tags: [
    ...
    var dbStatus6 =
        (await createTestStatus("seed6", dbAccount)).copyWith(tags: [
      PleromaTag(name: "#ca"),
    ]);
  ...
  test('createQuery onlyFromAccount', () async {
    ...
    await insertDbStatus(
        statusRepository,
        (await createTestStatus(
                "seed3", dbAccount.copyWith(remoteId: "newAccountRetmotId")))
            .copyWith());
    expect((await query.get()).length, 2);
  });
}
