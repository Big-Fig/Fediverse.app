...
class PleromaApiInstancePollLimits {
  ...
  static final PleromaApiInstancePollLimits defaultLimits =
    ...
    maxExpiration: defaultMaxPollExpiration.inMilliseconds ~/
        Duration.millisecondsPerSecond,
    minExpiration: defaultMinPollExpiration.inMilliseconds ~/
        Duration.millisecondsPerSecond,
    maxOptionChars: defaultMaxOptionChars,
    maxOptions: defaultMaxPollOptions,
  );

  Duration get minExpirationDurationOrDefault => minExpiration != null
      ? Duration(seconds: minExpiration!)
      : defaultMinPollExpiration;

  Duration get maxExpirationDurationOrDefault => maxExpiration != null
      ? Duration(seconds: maxExpiration!)
      : defaultMaxPollExpiration;
