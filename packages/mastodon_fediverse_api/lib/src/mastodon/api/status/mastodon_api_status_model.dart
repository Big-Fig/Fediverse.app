...
import 'package:mastodon_fediverse_api/src/mastodon/api/application/mastodon_api_application_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/card/mastodon_api_card_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/emoji/mastodon_api_emoji_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/media/attachment/mastodon_api_media_attachment_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/mention/mastodon_api_mention_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/poll/mastodon_api_poll_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/tag/mastodon_api_tag_model.dart';
import 'package:mastodon_fediverse_api/src/mastodon/api/visibility/mastodon_api_visibility_model.dart';
...
abstract class IMastodonApiScheduledStatusParams {
  ...
  IMastodonApiStatus? get inReplyToStatus;
