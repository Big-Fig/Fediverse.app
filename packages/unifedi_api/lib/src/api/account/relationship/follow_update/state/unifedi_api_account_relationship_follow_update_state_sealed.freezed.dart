...
/// @nodoc
class _$UnifediApiAccountRelationshipFollowUpdateStateTearOff {
  const _$UnifediApiAccountRelationshipFollowUpdateStateTearOff();

  _FollowPending followPending(
      {String stringValue = UnifediApiAccountRelationshipFollowUpdateState
...
/// @nodoc
const $UnifediApiAccountRelationshipFollowUpdateState =
    _$UnifediApiAccountRelationshipFollowUpdateStateTearOff();
...
class _$UnifediApiAccountRelationshipFollowUpdateStateCopyWithImpl<$Res>
  ...
  final UnifediApiAccountRelationshipFollowUpdateState _value;
  // ignore: unused_field
  final $Res Function(UnifediApiAccountRelationshipFollowUpdateState) _then;
...
class _$_FollowPending implements _FollowPending {
  ...
  @JsonKey(
      defaultValue: UnifediApiAccountRelationshipFollowUpdateState
          .followPendingStringValue)
  @override
