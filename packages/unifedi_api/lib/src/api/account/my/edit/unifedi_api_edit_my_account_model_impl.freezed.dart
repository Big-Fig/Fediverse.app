...
/// @nodoc
class _$UnifediApiEditMyAccountTearOff {
  const _$UnifediApiEditMyAccountTearOff();

  _UnifediApiEditMyAccount call(
    ...
    return _UnifediApiEditMyAccount(
...
/// @nodoc
const $UnifediApiEditMyAccount = _$UnifediApiEditMyAccountTearOff();
...
abstract class $UnifediApiEditMyAccountCopyWith<$Res> {
  factory $UnifediApiEditMyAccountCopyWith(UnifediApiEditMyAccount value,
      ...
      _$UnifediApiEditMyAccountCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'fields_attributes')
      @HiveField(1)
...
class _$UnifediApiEditMyAccountCopyWithImpl<$Res>
  ...
  final UnifediApiEditMyAccount _value;
  // ignore: unused_field
  final $Res Function(UnifediApiEditMyAccount) _then;
    ...
    return _then(_value.copyWith(
      ...
      alsoKnownAs: alsoKnownAs == freezed
          ...
          : alsoKnownAs // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      backgroundImageLocalFilePath: backgroundImageLocalFilePath == freezed
          ? _value.backgroundImageLocalFilePath
          : backgroundImageLocalFilePath // ignore: cast_nullable_to_non_nullable
              as String?,
      deleteBackgroundImage: deleteBackgroundImage == freezed
...
/// @nodoc
abstract class _$UnifediApiEditMyAccountCopyWith<$Res>
    implements $UnifediApiEditMyAccountCopyWith<$Res> {
  factory _$UnifediApiEditMyAccountCopyWith(_UnifediApiEditMyAccount value,
          $Res Function(_UnifediApiEditMyAccount) then) =
      __$UnifediApiEditMyAccountCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'fields_attributes')
      @HiveField(1)
...
/// @nodoc
class __$UnifediApiEditMyAccountCopyWithImpl<$Res>
    extends _$UnifediApiEditMyAccountCopyWithImpl<$Res>
    implements _$UnifediApiEditMyAccountCopyWith<$Res> {
  __$UnifediApiEditMyAccountCopyWithImpl(_UnifediApiEditMyAccount _value,
      $Res Function(_UnifediApiEditMyAccount) _then)
      : super(_value, (v) => _then(v as _UnifediApiEditMyAccount));

  @override
  _UnifediApiEditMyAccount get _value =>
      super._value as _UnifediApiEditMyAccount;
  ...
  $Res call({
    ...
    return _then(_UnifediApiEditMyAccount(
      fieldsAttributes: fieldsAttributes == freezed
          ? _value.fieldsAttributes
          : fieldsAttributes // ignore: cast_nullable_to_non_nullable
              as List<UnifediApiField>?,
...
/// @nodoc
@JsonSerializable()
class _$_UnifediApiEditMyAccount implements _UnifediApiEditMyAccount {
  const _$_UnifediApiEditMyAccount(
      {@JsonKey(name: 'fields_attributes')
      @HiveField(1)
  ...
  factory _$_UnifediApiEditMyAccount.fromJson(Map<String, dynamic> json) =>
      _$$_UnifediApiEditMyAccountFromJson(json);

  @override
  @JsonKey(name: 'fields_attributes')
  @HiveField(1)
  final List<UnifediApiField>? fieldsAttributes;
  @override
  @HiveField(2)
  ...
  _$UnifediApiEditMyAccountCopyWith<_UnifediApiEditMyAccount> get copyWith =>
      __$UnifediApiEditMyAccountCopyWithImpl<_UnifediApiEditMyAccount>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_UnifediApiEditMyAccountToJson(this);
  }
}
...
abstract class _UnifediApiEditMyAccount implements UnifediApiEditMyAccount {
  const factory _UnifediApiEditMyAccount(
      ...
      @JsonKey(name: 'delete_background_image')
      @HiveField(28)
          required bool? deleteBackgroundImage}) = _$_UnifediApiEditMyAccount;

  factory _UnifediApiEditMyAccount.fromJson(Map<String, dynamic> json) =
      _$_UnifediApiEditMyAccount.fromJson;
