...
// for that use the /statuses/:id/reactions endpoint.
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _UnifediApiStatus &&
            ...
            (identical(other.contentVariants, contentVariants) || const DeepCollectionEquality().equals(other.contentVariants, contentVariants)) &&
            (identical(other.conversationId, conversationId) || const DeepCollectionEquality().equals(other.conversationId, conversationId)) &&
            (identical(other.directConversationId, directConversationId) || const DeepCollectionEquality().equals(other.directConversationId, directConversationId)) &&
            (identical(other.inReplyToAccountAcct, inReplyToAccountAcct) || const DeepCollectionEquality().equals(other.inReplyToAccountAcct, inReplyToAccountAcct)) &&
            (identical(other.local, local) || const DeepCollectionEquality().equals(other.local, local)) &&
            (identical(other.spoilerTextVariants, spoilerTextVariants) || const DeepCollectionEquality().equals(other.spoilerTextVariants, spoilerTextVariants)) &&
            (identical(other.expiresAt, expiresAt) || const DeepCollectionEquality().equals(other.expiresAt, expiresAt)) &&
            (identical(other.threadMuted, threadMuted) || const DeepCollectionEquality().equals(other.threadMuted, threadMuted)) &&
            (identical(other.emojiReactions, emojiReactions) || const DeepCollectionEquality().equals(other.emojiReactions, emojiReactions)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(contentVariants) ^
      const DeepCollectionEquality().hash(conversationId) ^
      const DeepCollectionEquality().hash(directConversationId) ^
      const DeepCollectionEquality().hash(inReplyToAccountAcct) ^
      const DeepCollectionEquality().hash(local) ^
      const DeepCollectionEquality().hash(spoilerTextVariants) ^
      const DeepCollectionEquality().hash(expiresAt) ^
      const DeepCollectionEquality().hash(threadMuted) ^
...
// is associated with (if any)
  @HiveField(29 + 2)
  @JsonKey(name: 'direct_conversation_id')
  int? get directConversationId => throw _privateConstructorUsedError;
  @override // the acct property of User entity for replied user (if any)
  @JsonKey(name: 'in_reply_to_account_acct')
  @HiveField(29 + 3)
  String? get inReplyToAccountAcct => throw _privateConstructorUsedError;
