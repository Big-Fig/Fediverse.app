...
mixin _$ShareEntitySettings {
  ...
  @JsonKey(ignore: true)
  $ShareEntitySettingsCopyWith<ShareEntitySettings> get copyWith =>
...
class _$_ShareEntitySettings implements _ShareEntitySettings {
  ...
  @override
  String toString() {
    return 'ShareEntitySettings(appendFromAccount: $appendFromAccount, withCreatedAt: $withCreatedAt, withMedia: $withMedia, withText: $withText, withLink: $withLink, wholeAsLink: $wholeAsLink, mediaAsLink: $mediaAsLink, withMessage: $withMessage)';
  }
