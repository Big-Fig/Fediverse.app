...
class FediPadding {
  ...
  static const horizontalSmallPadding =
      EdgeInsets.symmetric(horizontal: FediSizes.smallPadding);
  ...
  static const verticalMediumPadding =
      EdgeInsets.symmetric(vertical: FediSizes.mediumPadding);
