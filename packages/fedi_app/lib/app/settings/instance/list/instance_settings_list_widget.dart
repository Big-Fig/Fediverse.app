import 'package:fedi_app/app/cache/database/settings/edit/global_or_instance/edit_global_or_instance_database_cache_settings_dialog.dart';
import 'package:fedi_app/app/cache/files/settings/edit/global_or_instance/edit_global_or_instance_files_cache_settings_dialog.dart';
import 'package:fedi_app/app/chat/settings/edit/global_or_instance/edit_global_or_instance_chat_settings_dialog.dart';
import 'package:fedi_app/app/config/config_service.dart';
import 'package:fedi_app/app/crash_reporting/settings/edit/global/edit_global_crash_reporting_settings_dialog.dart';
import 'package:fedi_app/app/localization/settings/edit/global/edit_global_localization_settings_dialog.dart';
import 'package:fedi_app/app/media/settings/edit/global_or_instance/edit_global_or_instance_media_settings_dialog.dart';
import 'package:fedi_app/app/pagination/settings/edit/global_or_instance/edit_global_or_instance_pagination_settings_dialog.dart';
import 'package:fedi_app/app/push/settings/edit/instance/edit_instance_push_settings_dialog.dart';
import 'package:fedi_app/app/settings/instance/list/instance_settings_list_widget_keys.dart';
import 'package:fedi_app/app/status/post/settings/edit/global_or_instance/edit_global_or_instance_post_status_settings_dialog.dart';
import 'package:fedi_app/app/status/sensitive/settings/edit/global_or_instance/edit_global_or_instance_status_sensitive_settings_dialog.dart';
import 'package:fedi_app/app/toast/settings/edit/global_or_instance/edit_global_or_instance_toast_settings_dialog.dart';
import 'package:fedi_app/app/ui/selection/fedi_selection_item_row_widget.dart';
import 'package:fedi_app/app/ui/settings/edit/global/edit_global_ui_settings_dialog.dart';
import 'package:fedi_app/app/web_sockets/settings/edit/global_or_instance/edit_global_or_instance_web_sockets_settings_dialog.dart';
import 'package:fedi_app/generated/l10n.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class InstanceSettingsListWidget extends StatelessWidget {
  const InstanceSettingsListWidget({Key? key}) : super(key: key);
